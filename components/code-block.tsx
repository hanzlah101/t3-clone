...
export const CodeBlockFiles = ({
  ...
  const { data } = React.useContext(CodeBlockContext)
...
export type CodeBlockFilenameProps = React.HTMLAttributes<HTMLDivElement> & {
  icon?: IconType
  value?: string
}
...
export const CodeBlockFilename = ({
  ...
  const { value: activeValue } = React.useContext(CodeBlockContext)
...
type CodeBlockFallbackProps = React.HTMLAttributes<HTMLDivElement>
...
export type CodeBlockItemProps = React.HTMLAttributes<HTMLDivElement> & {
  value: string
  lineNumbers?: boolean
}
...
export type CodeBlockContentProps = React.HTMLAttributes<HTMLDivElement> & {
  themes?: CodeOptionsMultipleThemes["themes"]
  language?: BundledLanguage
